...
func (in *ApplicationSourceKustomize) DeepCopyInto(out *ApplicationSourceKustomize) {
	*out = *in
	...
	if in.ConfigMapGenerators != nil {
		in, out := &in.ConfigMapGenerators, &out.ConfigMapGenerators
		*out = make(KustomizeConfigMapGenerators, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SecretGenerators != nil {
		...
		*out = make(KustomizeSecretGenerators, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KustomizeConfigMapGenerator) DeepCopyInto(out *KustomizeConfigMapGenerator) {
	*out = *in
	if in.Literals != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KustomizeConfigMapGenerator.
func (in *KustomizeConfigMapGenerator) DeepCopy() *KustomizeConfigMapGenerator {
	if in == nil {
		return nil
	}
	out := new(KustomizeConfigMapGenerator)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in KustomizeConfigMapGenerators) DeepCopyInto(out *KustomizeConfigMapGenerators) {
	{
		in := &in
		*out = make(KustomizeConfigMapGenerators, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KustomizeConfigMapGenerators.
func (in KustomizeConfigMapGenerators) DeepCopy() KustomizeConfigMapGenerators {
	if in == nil {
		return nil
	}
	out := new(KustomizeConfigMapGenerators)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KustomizeSecretGenerator) DeepCopyInto(out *KustomizeSecretGenerator) {
	*out = *in
	if in.Literals != nil {
		in, out := &in.Literals, &out.Literals
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KustomizeSecretGenerator.
func (in *KustomizeSecretGenerator) DeepCopy() *KustomizeSecretGenerator {
	if in == nil {
		return nil
	}
	out := new(KustomizeSecretGenerator)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in KustomizeSecretGenerators) DeepCopyInto(out *KustomizeSecretGenerators) {
	{
		in := &in
		*out = make(KustomizeSecretGenerators, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KustomizeSecretGenerators.
func (in KustomizeSecretGenerators) DeepCopy() KustomizeSecretGenerators {
	if in == nil {
		return nil
	}
	out := new(KustomizeSecretGenerators)
	in.DeepCopyInto(out)
	return *out
}
