...
type ApplicationSourceKustomize struct {
	...
	ConfigMapGenerators KustomizeConfigMapGenerators `json:"configMapGenerators,omitempty" protobuf:"bytes,7,opt,name=configMapGenerators"`
	SecretGenerators    KustomizeSecretGenerators    `json:"secretGenerators,omitempty" protobuf:"bytes,8,opt,name=secretGenerators"`
}
